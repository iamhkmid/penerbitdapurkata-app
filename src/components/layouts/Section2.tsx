...
const Section2 = forwardRef(() => {
    ...
    return (
        <div ref={sectionRef} className=" py-5 bg-gray-50 font-roboto bg-gradient-to-r from-gray-100 to-white">
            <h1 className="text-3xl font-bold uppercase text-center pt-3">Spesifikasi Naskah</h1>
            <hr className="text-gray-500 border-t-2 border-gray-300 mx-24 pb-5"></hr>
