...
const Section2 = forwardRef((props: props, ref) => {
  ...
  return (
    <div
      ref={sectionRef}
      className="py-14 font-roboto bg-gradient-to-r from-gray-200 to-gray-50 min-h-screen flex flex-col place-content-center"
    >
      <div>
        ...
        <div className="flex  flex-col md:flex-row justify-items-center items-center place-content-evenly px-5 ">
          {props.spesifikasi.map((data, index) => (
            <div
              key={data.name}
              className="md:w-1/3 group text-gray-900 hover:bg-gray-50 border-transparent border-4 hover:border-indigo-200 rounded-md cursor-default my-5"
            >
              {data.name === "isi" ? (
                <div className="flex flex-col px-5 py-2 justify-items-center items-center text-center">
                  ...
                  <h1 className="text-2xl font-bold uppercase  mt-3 mb-1">
                    {" "}
                    {data.name}
                  </h1>
                  <h1 className="text-base font-medium ">
                    <span className="bg-indigo-200 rounded-lg px-1">Warna</span>{" "}
                    : {data.warna}
                  </h1>
                  <h1 className="text-base font-medium ">
                    <span className="bg-indigo-200 rounded-lg px-1">
                      Jenis Kertas
                    </span>{" "}
                    : <span className="italic">{data.jenisKertas[0]}</span>
                    <span>{data.jenisKertas[1]}</span>
                  </h1>
                  <h1 className="text-base font-medium ">
                    <span className="bg-indigo-200 rounded-lg px-1">
                      Ukuran
                ...
                <div className="flex flex-col px-5 py-2 justify-items-center items-center text-center">
                  ...
                  <div className="text-base font-medium ">
                    <span className="bg-indigo-200 rounded-lg px-1">Warna</span>{" "}
                    : <span className="italic">{data.warna}</span>
                  </div>
                  <div className="text-base font-medium ">
                    <span className="bg-indigo-200 rounded-lg px-1">
                      Jenis Kertas
                  ...
                  <div className="text-base font-medium ">
                    ...
                    : {data.laminasi}
                    <span className="text-sm text-gray-600">{` ${data.att}`}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col px-5 py-2 justify-items-center items-center text-center">
                  ...
                  {data.values.map((item, index) => (
                    <h1 key={item[0]} className="text-base font-medium ">
                      <span>{item[0]}</span>
