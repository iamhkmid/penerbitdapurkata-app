...
const Footer = () => {
  return (
    <div className="flex flex-col bg-gray-900">
      <div className="flex flex-wrap justify-center py-5 md:py-10 bg-gray-800 text-center md:text-left ">
        <div className="w-auto md:w-1/3 text-white px-20 my-5 md:my-0">
          <h1 className="text-2xl font-semibold mb-3"> No. Telp</h1>
          <h1>{data.footer.noWa}</h1>
        </div>
        <div className=" w-auto md:w-1/3 text-white px-10 my-5 md:my-0">
